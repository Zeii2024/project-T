  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="description" label="项目描述">
        <textarea placeholder="项目描述" @input="binddata('description', $event.detail.value)" class="uni-textarea-border" v-model="formData.description"></textarea>
      </uni-forms-item>
      <uni-forms-item name="project_type" label="">
        <uni-easyinput placeholder="项目类型，1：个人，2：企业" type="number" v-model="formData.project_type"></uni-easyinput>
      </uni-forms-item>
      ...
      <uni-forms-item name="stages" label="">
        <uni-data-picker :multiple="true" v-model="formData.stages" collection="admin-stages" field="stage_id as value"></uni-data-picker>
      </uni-forms-item>
      <uni-forms-item name="state" label="">
        <uni-easyinput placeholder="项目所处状态，1:未开始，2：进行中，3：已结束，4：延期中，5：已中止" type="number" v-model="formData.state"></uni-easyinput>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/admin-projects.js';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("project_id,name,description,project_type,owner_id,members,stages,state,cost,total_cost,other_cost,start_time,end_time,create_date").get().then((res) => {
