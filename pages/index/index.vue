<template>
	...
	<view class="fix-top-window">
		<!-- start -->
		<view class="uni-header" style="display: flex;float: left;width: 30%; margin-right: 10rpx;">
			<view class="uni-container" align="center">左边项目列表栏
				<uni-table class="uni-container">
					<uni-tr>
						<uni-th align="center">
							项目列表
						</uni-th>
					</uni-tr>
					<!-- <uni-tr v-for="(p,index) in projcts" :key="name" align="center">
						<uni-th align="center">
							{{p.name}}
						</uni-th>
					</uni-tr> -->
		...
		<view class="uni-container">
			...
			<uni-notice-bar v-if="!deviceTableData.length && !userTableData.length && !query.platform_id && complete"
				showGetMore showIcon class="mb-m pointer" text="暂无数据, 统计相关功能需开通 uni 统计后才能使用, 如未开通, 点击查看具体流程"
